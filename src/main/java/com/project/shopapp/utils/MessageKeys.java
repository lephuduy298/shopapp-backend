...
public class MessageKeys {
    ...
    public static final String USER_NOTFOUND =  "user.login.user_not_found";
    ...
    public static final String PHONE_ALREADY_EXISTED = "user.register.phone_number_already_existed";
    public static final String ADMIN_ROLE_NOT_AVAILABLE = "user.register.admin_role_not_available";
